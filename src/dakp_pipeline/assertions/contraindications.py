...
SPL set evidence is emitted as ``dailymed:<spl_set_id>`` CURIEs to match the deployed Translator
ingest contract. ``primary_knowledge_source = infores:multiomics-drugapprovals``,
...
from dakp_pipeline.assertions.evidence import build_dailymed_evidence, dailymed_set_curie, sorted_pipe, write_assertion_table
