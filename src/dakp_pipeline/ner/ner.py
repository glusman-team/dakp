...
from dakp_pipeline.ner.dictionary import MENTION_TYPES, OBJECT_TYPES, TYPE_DISEASE, TYPE_PHENOTYPE, Gazetteer, canonical_type, normalize_text
...
# GLiNER2-native boundary checkpoint (``max_len: 4096``). The previous v1 domain fine-tune of
...
class DiseaseNER:
    ...
    def extract_batch(self, texts: Sequence[str]) -> list[list[Mention]]:
        ...
        for index, text in enumerate(values):
            ...
            output.append(sorted(emitted, key=_sort_key))
        return output
